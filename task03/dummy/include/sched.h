...
#define PF_MEMALLOC                                   \
  0x00000800 /* Allocating memory to free memory. See \
...
#define PF_MEMALLOC_PIN                                                \
  0x10000000 /* Allocations constrained to zones which allow long term \
              * pinning. See memalloc_pin_save() */
...
extern void set_cpus_allowed_force(struct task_struct* p,
...
extern int set_cpus_allowed_ptr(struct task_struct* p,
                                const struct cpumask* new_mask);
extern int dup_user_cpus_ptr(struct task_struct* dst,
...
extern void __set_task_comm(struct task_struct* tsk,
                            const char* from,
                            bool exec);
...
static inline void update_tsk_thread_flag(struct task_struct* tsk,
                                          int flag,
                                          bool value) {
...
extern int sched_core_share_pid(unsigned int cmd,
                                pid_t pid,
                                enum pid_type type,
                                unsigned long uaddr);
